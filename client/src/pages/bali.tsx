...
export default function Bali() {
  ...
  const [ubudRef, ubudVisible] = useIntersectionObserver();
  const [seminyakRef, seminyakVisible] = useIntersectionObserver();
  const [nusaPenidaRef, nusaPenidaVisible] = useIntersectionObserver();
  const [uluwatuRef, uluwatuVisible] = useIntersectionObserver();
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      <main className="pt-20">
            ...
            <div className="mb-16">
              ...
              <div className="mb-16">
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="order-1 md:order-2">
                    <h3 className="font-heading text-2xl font-bold text-white mb-4">
                      Seminyak & Kuta – Beaches, Shopping & Nightlife
                    </h3>
                    <p className="text-gray-300 mb-4">
                      Seminyak and Kuta are popular for beaches, cafes, nightlife, and shopping. Seminyak Beach is known for luxury beach clubs, boutique stores, spa experiences, and trendy restaurants. Kuta is more lively and perfect for surfing, nightlife, and affordable shopping options. These areas are ideal for travelers who want a mix of fun, relaxation, and entertainment during their Bali holiday package.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-16">
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div>
                    <h3 className="font-heading text-2xl font-bold text-white mb-4">
                      Nusa Penida – One-Day Island Excursion
                    </h3>
                    <p className="text-gray-300 mb-4">
              ...
              <div className="mb-16">
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="order-1 md:order-2">
                    <h3 className="font-heading text-2xl font-bold text-white mb-4">
                      Uluwatu – Clifftop Views & Sunset Experiences
                    </h3>
                    <p className="text-gray-300 mb-4">
        ...
        <section className={`py-16 bg-gray-900 ${destinationsVisible ? "animate-fade-in-up" : ""}`}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className={`text-center mb-12 ${destinationsVisible ? "animate-fade-in-up" : ""}`}>
              <h2 className="font-heading text-3xl md:text-4xl font-bold text-white mb-4">
                Bali Itinerary
              </h2>
        ...
        <section className={`py-16 bg-gray-900 ${destinationsVisible ? "animate-fade-in-up" : ""}`}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className={`text-center ${destinationsVisible ? "animate-fade-in-up" : ""}`}>
        ...
        <section className={`py-10 bg-gray-900 ${destinationsVisible ? "animate-fade-in-up" : ""}`}>
