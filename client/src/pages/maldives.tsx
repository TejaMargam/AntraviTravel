...
export default function Maldives() {
  ...
  const isLuxuryResort = (resort: Resort) =>
    resort.tag.trim().toLowerCase() === "5-star luxury";

  const filterResortByRating = (resort: Resort) => {
    if (selectedFilter === "all") return true;
    if (selectedFilter === "4-star") return resort.rating === 4;
    if (selectedFilter === "5-star") return resort.rating === 5;
    if (selectedFilter === "luxury") return isLuxuryResort(resort);
    return true;
  };
              ...
              {filteredResorts.map((resort) => (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <p style={{ fontFamily: 'var(--font-sans)', fontSize: '0.85rem', color: 'var(--mid-gray)', marginTop: '0.5rem' }}>
          ...
          {filteredLuxuryResorts.length > 0 && (
            <div className="mt-16" id="luxury-resorts">
              <div className="text-center mb-10">
                ...
                <div className="editorial-divider" />
                <h3 style={{ fontFamily: 'var(--font-serif)', fontSize: 'clamp(1.75rem, 3vw, 2.5rem)', fontWeight: 400, color: 'var(--charcoal)', marginBottom: '0.75rem' }}>
                  Luxury Resorts
                </h3>
                <p style={{ fontFamily: 'var(--font-sans)', fontSize: '1rem', color: 'var(--mid-gray)', maxWidth: '44rem', margin: '0 auto', lineHeight: 1.8 }}>
                  Our 5-star luxury Maldives collection for travellers looking for the most elevated island stays.
                </p>
              </div>
      ...
      <section className="py-20" style={{ backgroundColor: '#ffffff' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="text-center">
              <img
                src={getImagePath("images/maldives/resorts/arrival/arrival-image-2.webp?w=800&h=600&fit=crop")}
                alt="Maldives island stay"
                className="aspect-video w-full rounded-lg object-cover mb-4"
              />
              <h3 style={{ fontFamily: 'var(--font-serif)', fontSize: '1.5rem', fontWeight: 500, color: 'var(--charcoal)', marginBottom: '1rem' }}>
          ...
          <p className="text-center mt-8" style={{ fontFamily: 'var(--font-sans)', fontStyle: 'italic', color: 'var(--mid-gray)' }}>
            90% of travellers choose private island resorts.
          </p>
        </div>
      </section>
